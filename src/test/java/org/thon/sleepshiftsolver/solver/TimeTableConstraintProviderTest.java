...
class TimeTableConstraintProviderTest {
    ...
    private static final Bed ROOM1 = new Bed("Room1");
    private static final Bed ROOM2 = new Bed("Room2");
    private static final SleepShift TIMESLOT1 = new SleepShift(DayOfWeek.MONDAY, LocalTime.NOON);
    private static final SleepShift TIMESLOT2 = new SleepShift(DayOfWeek.TUESDAY, LocalTime.NOON);
    private static final SleepShift TIMESLOT3 = new SleepShift(DayOfWeek.TUESDAY, LocalTime.NOON.plusHours(1));
    private static final SleepShift TIMESLOT4 = new SleepShift(DayOfWeek.TUESDAY, LocalTime.NOON.plusHours(3));
